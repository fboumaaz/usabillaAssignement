 ...
 * @param {Array} arrItems //this is the array of feedbacks items
 ...
 */
   ...
   * @param {array} arrItems //this is array of feedbacks items
   ...
   * @returns {Array} //this array of feedback items after filter
    */
  filterItemsByComment(query : string){
    this.filterdItems = (query)?
 ...
 */
  ...
  updateRatingFilter(ratingFiltersArray,selectedRateFilter){
    if(_.contains(ratingFiltersArray,selectedRateFilter.rating)){
      ratingFiltersArray = _.without(ratingFiltersArray,selectedRateFilter.rating)
      this.updateRatesStyle(this.allRates,selectedRateFilter.rating ,'btn btn-default');
    }
    else{
      ratingFiltersArray.push(selectedRateFilter.rating);
   ...
   * @param {Array} arrItems //this is array if feedbacks items
 ...
 * @param {Array} items //this is array if feedbacks items
 ...
 */
  filterRating(selectedRateFilter){
    this.updateRatingFilter(this.ratingFilters,selectedRateFilter);
